              ...
              <div className="absolute top-3 right-4 flex flex-col gap-2">
                ...
                <div className="flex flex-row justify-end gap-2">
                  {shareManu && (
                    <div className="flex flex-row justify-end gap-2">
                      <Link
                        href={`whatsapp://send?text=${process.env.NEXT_PUBLIC_URL}/category/${category}/${degree}/${semester}/${mainSubject}/${subject}`}
                        target="_blank"
                      ...
                      <Link
                        href={`mailto:?subject=${subject} | ${category}&body=${subject} | ${category} URL send via UniSmart.com
                      
                      
                      ${process.env.NEXT_PUBLIC_URL}/category/${category}/${degree}/${semester}/${mainSubject}/${subject}`}
                        target="_blank"
                        className="rounded-full bg-transparent px-2 py-2 text-sm font-semibold text-white shadow-sm hover:bg-black/10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
                      >
                      ...
                      <Link
                        href={`https://telegram.me/share/url?url=${process.env.NEXT_PUBLIC_URL}/category/${category}/${degree}/${semester}/${mainSubject}/${subject}`}
                        target="_blank"
                        className="rounded-full bg-transparent px-2 py-2 text-sm font-semibold text-white shadow-sm hover:bg-black/10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
                      >
                      ...
                      <Link
                        href={`sms:?body=${subject} | ${category} URL send via UniSmart.com
