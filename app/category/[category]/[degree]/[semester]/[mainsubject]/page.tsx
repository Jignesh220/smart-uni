          ...
          <div className="flex justify-center md:pt-8 min-[0px]:pt-5">
            <div className="flex flex-row md:gap-3 min-[0px]:gap-1 bg-blue-50 p-2 md:px-7 min-[0px]:px-3 rounded-full">
              ...
              <Link
                ...
                className="md:text-base min-[0px]:text-xs font-outfit text-blue-700 hover:underline underline-offset-4 my-auto flex flex-row gap-2"
              >
                <span>Semester</span>
              ...
              <div className="md:text-base min-[0px]:text-xs font-outfit text-black my-auto">
                {params.mainsubject}
              </div>
            </div>
          </div>
